        ...
        public static Net Instance
        {
            get
            {
                ...
                lock (_lock)
                {
                    ...
                    if (FindObjectsOfType(typeof(Net)).Length > 1)
                    {
                        Debug.LogError("[Net] Something went really wrong " +
                                       " - there should never be more than 1 Net instance!" +
                    ...
                    if (s_instance == null)
                    {
                        ...
                        s_instance = obj2.AddComponent<Net>();
                        obj2.name = "Net.Instance";
                        ...
                        if (s_instance != null)
                        {
                            ...
                            s_instance.NetErrorCallback =
                                (type, id, msg) => Debug.LogError(string.Format("Net error:{0}-{1}", id, msg));
                        }
                    }
                }
                return s_instance;
